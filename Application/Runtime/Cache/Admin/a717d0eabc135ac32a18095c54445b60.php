                ...
                <div id="Right">
                    ...
                    <form method="POST" action="/">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                            ...
                            <tr>
                                <th width="100">大赛名：</th>
                                <td><input id="title" type="text" class="input" size="20" name="info[title]" value="<?php echo ($info["title"]); ?>"/> </td>
                            </tr>
                            ...
                            <tr>
                                <th>奖池比率：</th>
                                <td><input type="text" class="input" size="20" name="info[pool]" value="<?php echo ($info["pool"]); ?>"/></td>
                            </tr>
                            <tr>
                                <th>销售矿机台数：</th>
                            ...
                            <tr>
                            <th>考核小区：</th>
                                <td><input type="text" class="input" size="20" name="info[residential]" value="<?php echo ($info["residential"]); ?>" disabled/></td>
                            </tr>
                           ...
                           <!--  <tr>
                            ...
                            <tr>
                                <th>课次：</th>
                                <td><input type="text" class="input" size="40" name="time" value="<?php echo ($info["time"]); ?>"/> </td>
                            </tr>
                            <tr>
                                <th>时间：</th>
                                <td><input type="text" class="input" size="60" name="info[class_time]" value="<?php echo ($info["keywords"]); ?>"/> </td>
                            </tr>
                            <tr>
                                <th>地点：</th>
                                <td><input type="text" class="input" size="60" name="info[address]" value="<?php echo ($info["keywords"]); ?>"/> </td>
                            </tr>
                            <tr>
                                <th>要求：</th>
                                <td><textarea class="input" style="height: 60px; width: 600px;" name="info[require]"><?php echo ($info["require"]); ?></textarea> </td>
                            </tr>
                            <tr>
                                <th>产品描述：</th>
        ...
        <script type="text/javascript">
            ...
            $(function(){
                ...
                $(".submit").click(function(){
                    ...
                    // content.sync();
                    commonAjaxSubmit("/index.php/conist/Product/matchedit");
                    return false;
                });
            });
        </script>
