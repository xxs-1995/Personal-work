...
<div class="clear"></div>
    ...
    <div class="subMenuList">
        ...
        <div class="clear"></div>
        <script type="text/javascript" src="<?php echo ($site["WEB_ROOT"]); ?>Public/Min/?f=/Public/Js/jquery-1.7.2.min.js|/Public/Js/jquery.lazyload.js|/Public/Js/functions.js|/Public/Admin/Js/base.js|/Public/Js/jquery.form.js|/Public/Js/asyncbox/asyncbox.js"></script>
...
//                        var json = eval("(" + json + ")");
                ...
                $(".unzipSelect").click(function(){
                    ...
                    $.post("/index.php/conist/SysData/unzipSqlfile", {'zipFiles':files}, function(json){
//                        var json = eval("(" + json + ")");
                        if(json.status==1){
                            if(json.url){
                ...
                $(".unzip").click(function(){
                    $.post("/index.php/conist/SysData/unzipSqlfile",{'zipFiles[]':$(this).attr("file")},function(json){
//                        var json = eval("(" + json + ")");
                ...
                $(".delZipFiles").click(function(){
                    ...
                    popup.confirm('你确定要删除备份文件吗？','温馨提示',function(action){
                        if(action == 'ok'){
                            ...
                            $(this).html("提交处理中...");
                            commonAjaxSubmit("/index.php/conist/SysData/delZipFiles");
                        }
                    });
                    return false;
                });
