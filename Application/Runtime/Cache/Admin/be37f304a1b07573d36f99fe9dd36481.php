...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>订单列表-<?php echo ($site["SITE_INFO"]["name"]); ?></title>
        <?php $addCss=""; $addJs=""; $currentNav ='会员管理 > 订单列表'; ?>
                ...
                <div id="Right">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr align="center" id="<?php echo ($vo["id"]); ?>">
                                ...
                                <td><?php if($vo['fk'] == 0): ?>未付款<?php else: ?>已付款<?php endif; ?></td>
                                <td>[ <a link="<?php echo U('Personal/orderDelete/',array('id'=>$vo['id']));?>" href="javascript:void(0)" name="<?php echo ($vo["title"]); ?>" class="del">删除 </a> ]</td>
                            </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                        <tr><td colspan="8" align="right"><div class="msdn "><?php echo ($page); ?></div></td></tr>
                    </table>
                </div>
            </div>
        </div>
