...
<head>
    ...
    <title>网站管理-<?php echo ($site["SITE_INFO"]["name"]); ?></title>
    <?php $addCss=""; $addJs=""; $currentNav ='网站管理 > 轮播列表'; ?>
...
<div class="clear"></div>
    ...
    <div class="subMenuList">
        ...
        <div id="Right">
            <div class="Item hr">
                <div class="current" style="max-width: 100px; float: left;">轮播列表</div>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr align="center" id="<?php echo ($vo["id"]); ?>">
                        ...
                        <td><img src="<?php echo ($vo["ad_img"]); ?>" border="0" height="40" width="200"></td>
