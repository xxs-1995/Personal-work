...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <?php $addCss=""; $addJs=""; $currentNav ='参数设置 > 补贴·列表'; ?>
    ...
    <div class="subMenuList">
        ...
        <ul>
            <?php if(is_array($sub_menu)): foreach($sub_menu as $key=>$sv): ?><li><a href="<?php echo ($sv["url"]); ?>"><?php echo ($sv["title"]); ?></a></li><?php endforeach; endif; ?>
                ...
                <div id="Right">
                    <div class="Item hr">
                        <div class="current">今日符合条件的用户</div>
                    </div>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
                        ...
                        <?php if(is_array($accord)): $i = 0; $__LIST__ = $accord;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr align="center" id="<?php echo ($vo["id"]); ?>">
                                <td align="left"><?php echo ($vo["user_id"]); ?></a></td>
                                <td><?php echo ($vo["user_nickname"]); ?></td>
                                <td><?php echo ($vo["user_tel"]); ?></td>
                                <td><?php echo ($vo["qualifications"]); ?></td>
                                <td><?php echo ($vo["teamprice"]); ?></td>
