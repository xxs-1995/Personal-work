...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo ($site["WEB_ROOT"]); ?>Public/Min/?f=/Public/Admin/Css/base.css|/Public/Admin/Css/layout.css|/Public/Js/asyncbox/skins/default.css<?php echo ($addCss); ?>" />
    </head>
    <body>
        <div class="wrap">
            <div id="Top">
...
<div class="clear"></div>
    ...
    <div class="subMenuList">
        ...
        <div class="clear"></div>
        <link rel="stylesheet" type="text/css" href="<?php echo ($site["WEB_ROOT"]); ?>Public/Min/?f=/Public/Js/poshytip/tip-yellow/tip-yellow.css|/Public/Js/poshytip/tip-yellowsimple/tip-yellowsimple.css" />
        <script type="text/javascript" src="<?php echo ($site["WEB_ROOT"]); ?>Public/Min/?f=/Public/Js/jquery-1.7.2.min.js|/Public/Js/jquery.lazyload.js|/Public/Js/functions.js|/Public/Admin/Js/base.js|/Public/Js/jquery.form.js|/Public/Js/asyncbox/asyncbox.js|/Public/Js/poshytip/jquery.poshytip.min.js"></script>
...
//                        var json = eval("(" + json + ")");
                ...
                $(".sendSql").click(function(){
                    ...
                    popup.open({id:"ifrSendSql", url : "/index.php/conist/SysData/sendSql", width : 400, height : 100, buttons : [{ value : '确定发送邮件',result : 'submit'},{ value : '取消',result : 'cancel'}],callback : function(btnRes,cntWin,reVal){
                            if(btnRes == "submit"){
                                ...
                                if (Reg.test(email)) {
                                    ...
                                    $("form").ajaxSubmit({url:"/index.php/conist/SysData/sendSql",type:"POST",success:function(json, st) {
//                                            var json = eval("(" + json + ")");
                                            if(json.status==1){
                                                if(json.url){
                ...
                $(".restore").click(function(){
                    ...
                    $(".btn").attr("disabledSubmit",true);
                    $.getJSON("/index.php/conist/SysData/restoreData", {sqlPre:sqlPre}, function(json){
                        if(json.status==1){
                            if(json.url){
                                $("#opStatus").show().html(json.info);
                ...
                $(".delSqlFiles").click(function(){
                    ...
                    popup.confirm('你确定要删除备份文件吗？','温馨提示',function(action){
                        if(action == 'ok'){
                            $(".btn").attr("disabledSubmit",true);
                            $(this).html("提交处理中...");
                            commonAjaxSubmit("/index.php/conist/SysData/delSqlFiles");
                        }
                    });
                    return false;
                });
                ...
                $(".zip").click(function(){
                    ...
                    commonAjaxSubmit("/index.php/conist/SysData/zipSql");
                    $(".btn").attr("disabledSubmit",true);
                    $(this).html("压缩中...");
                    return false;
                });
