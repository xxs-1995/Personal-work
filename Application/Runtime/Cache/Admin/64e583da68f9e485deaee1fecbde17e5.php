...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <?php $addCss=""; $addJs=""; $currentNav ='会员管理 > 佣金列表'; ?>
        ...
        <ul>
            <?php if(is_array($sub_menu)): foreach($sub_menu as $key=>$sv): ?><li><a href="<?php echo ($sv["url"]); ?>"><?php echo ($sv["title"]); ?></a></li><?php endforeach; endif; ?>
                ...
                <div id="Right">
                    ...
                    <!-- <form action="<?php echo U('Personal/computing');?>" method="get">
                                        类型：
                                        <select name="type" class="type">
                                            <option value="">全部</option>
                                            <option value="1" <?php if($_GET['type']==1)echo selected; ?>>1级销售奖励</option>
                                            <option value="2" <?php if($_GET['type']==2)echo selected; ?>>2级销售奖励</option>
                                        </select>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr align="center" id="<?php echo ($vo["id"]); ?>">
                                ...
                                <td align="center"><?php echo ($vo["personal"]["user_nickname"]); ?></td>
                                <td><?php echo ($vo["type"]); ?></td>
                                <td><?php echo ($vo["currency"]); ?></td>
                                <td><?php echo ($vo["suanli"]); ?></td>
                                <td><?php echo ($vo["payno"]); ?></td>
                                <td><?php echo (date("Y-m-d H:i:s",$vo["createtime"])); ?></td>
                                <td>
                                   [ <a href="<?php echo U('Personal/computing_info/',array('id'=>$vo['id'],'user_id'=>$vo['user_id']));?>" >查看 </a> ]
                                </td>
