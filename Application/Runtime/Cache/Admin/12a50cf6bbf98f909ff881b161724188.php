...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <?php $addCss=""; $addJs=""; $currentNav ='参数设置 > 大赛列表'; ?>
            ...
            <?php if(is_array($sub_menu)): foreach($sub_menu as $key=>$sv): ?><li><a href="<?php echo ($sv["url"]); ?>"><?php echo ($sv["title"]); ?></a></li><?php endforeach; endif; ?>
                ...
                <div id="Right">
                    <div class="Item hr">
                        ...
                        <span style="float:right"><div class="current"><a href="/index.php/conist/Product/matchadd">添加大赛</a></div></span>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
                        ...
                        <?php if(is_array($match)): $i = 0; $__LIST__ = $match;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr align="center" id="<?php echo ($vo["mid"]); ?>">
                                <td><?php echo ($vo["mid"]); ?></td>
                                <td align="left"><?php echo ($vo["title"]); ?></a></td>
                                <td><?php echo ($vo["pool"]); ?></td>
                                <td><?php echo ($vo["num"]); ?></td>
                                <td><?php echo ($vo["price"]); ?></td>
                                <td><?php echo ($vo["residential"]); ?></td>
                                ...
                                <td>[ <a href="/index.php/conist/Product/matchedit?id=<?php echo ($vo["mid"]); ?>">编辑 </a> ] [ <a link="<?php echo U('Product/matchdel/',array('id'=>$vo['mid']));?>" href="javascript:void(0)" name="<?php echo ($vo["title"]); ?>" class="del">删除 </a> ]</td>
