...
<div class="clear"></div>
    ...
    <div class="subMenuList">
        ...
        <div id="Right">
            <div class="Item hr">
                <div class="current" style="max-width: 100px; float: left;">认证管理</div>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tab">
                ...
                <tr><td colspan="7" align="left">
                            <form action="/index.php/conist/Personal/recommend" method="get">
                ...
                <tbody>
                <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tree): $mod = ($i % 2 );++$i;?><tr pid="<?php echo ($tree["id"]); ?>" cid="<?php echo ($tree["id"]); ?>">
                        <!-- 0 -->
                        <input type="hidden" name="id" value="<?php echo ($tree["id"]); ?>"/>
                        <!-- 1 -->
                        <td  align="center"><?php echo ($tree["id"]); ?></td>
                        <td  align="center"><?php echo ($tree["real_name"]); ?></td>
                        <!-- 2 -->
                         <td align="center"><?php echo ($tree["mobile"]); ?></td>
                        <!-- 3 -->
                        <td align="center"><?php echo ($tree["age"]); ?></td>
                        <!-- 4 -->
                        <td align="center"><?php if($tree['sex'] == 0){ ?>
                            <?php echo "女";?>
                        <?php }else{ ?>
                            <?php echo "男";?>
                        <?php }?></td>
                        ...
                        <!-- 6 -->
                        <td align="center"><?php echo ($tree["id_number"]); ?></td>
                        <!-- 7 -->
                        <td align="center"><?php echo ($tree["wx"]); ?></td>
                        <!-- 8 -->
                   <!--      <td align="center"><?php switch($tree["level"]): case "0": ?>用户<?php break;?>
                                                <?php case "1": ?>会员<?php break;?>
                                                <?php case "2": ?>总监<?php break;?>
                                                <?php case "3": ?>合伙人<?php break; endswitch;?></td> --> 
                        <!-- <td align="center"><?php echo ($tree["user_type"]); ?></td> -->
                        <!-- 9 -->
                        <td align="center"><?php echo ($tree["alipay"]); ?></td>
                        <!-- 10 -->
                        <!-- <td align="center"><?php echo ($tree["user_artdirection"]); ?></td> -->
                        <!-- 11 -->
                        <!-- <td align="center"><?php echo ($tree["user_achievement"]); ?></td> -->
                        <!-- 12 -->
                        <td align="center"><?php if($tree['auth'] == 0){ ?>
                            <?php echo "未认证";?>
                        <?php }else{ ?>
                            <?php echo "已认证";?>
                        <?php }?></td>
                      ...
                      <!--   <td align="center"></td> -->
                        ...
                        <td align="center" ><!-- <button class="btn" onclick="window.location.href='<?php echo U('Personal/picarr');?>?id=<?php echo ($tree["user_id"]); ?>'">相册</button> -->
                            ...
                            <button class="btn" onclick="window.location.href='<?php echo U('Personal/select');?>?id=<?php echo ($tree["user_id"]); ?>'">认证通过</button>
                           <!--  <button class="btn" onclick="window.location.href='<?php echo U('Order/index');?>?user_id=<?php echo ($tree["user_id"]); ?>'">认证信息</button>
                             -->
