                    ...
                    <form>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                            ...
                            <tr>
                                ...
                                <td><input id="title" type="text" class="input" size="60"  value="<?php echo ($info["name"]); ?>" disabled/> </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><select name="paytype">
                                    ...
                                    <option value="1" <?php if($info["paytype"] == 1): ?>selected<?php endif; ?> >BOW支付</option>
                                    <option value="2" <?php if($info["paytype"] == 2): ?>selected<?php endif; ?> >50%算力+50%ITG支付</option>
                                </select>
                            </td>
                            </tr>
                            <!-- <tr>
