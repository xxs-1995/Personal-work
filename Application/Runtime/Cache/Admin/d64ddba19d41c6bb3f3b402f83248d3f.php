        ...
        <div id="Right">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr align="center" id="<?php echo ($vo["id"]); ?>">
                        ...
                        <td><?php echo ($vo["personal"]["user_nickname"]); ?></td>
                        <td><?php echo ($vo["personal"]["user_tel"]); ?></td>
                        ...
                        <td><a href="<?php echo U('Siteinfo/message_info/',array('id'=>$vo['id']));?>">查看</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a link="<?php echo U('Siteinfo/delmessage/',array('id'=>$vo['id']));?>" href="javascript:void(0)" name="<?php echo ($vo["id"]); ?>" class="del">删除</a> </td>
