...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <?php $addCss=""; $addJs=""; $currentNav ='参数设置 > 添加项目投资'; ?>
    ...
    <div class="subMenuList">
        ...
        <ul>
            <?php if(is_array($sub_menu)): foreach($sub_menu as $key=>$sv): ?><li><a href="<?php echo ($sv["url"]); ?>"><?php echo ($sv["title"]); ?></a></li><?php endforeach; endif; ?>
                ...
                <div id="Right">
                    <div class="Item hr">
                        <div class="current">添加项目入驻投资</div>
                    </div>
                    <form>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                            <tr>
                                <th width="100">入驻用户ID：</th>
                                <td><input id="title" type="text" class="input" size="60" name="info[eid]" value="<?php echo ($info["eid"]); ?>"/> </td>
                            </tr>
                        ...
                        <?php }else{ $action_url='/index.php/conist/Personal/createbi'; } ?>
                    </form>
        ...
        <script type="text/javascript">
            ...
            $(function(){
                ...
                $("#checkNewsTitle").click(function(){
                    ...
                    $.getJSON("/index.php/conist/Personal/checkProductTitle", { title:$("#title").val(),id:"<?php echo ($info["id"]); ?>"}, function(json){
