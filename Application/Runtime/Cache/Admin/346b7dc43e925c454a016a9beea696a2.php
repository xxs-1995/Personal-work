...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>企业账户列表-<?php echo ($site["SITE_INFO"]["name"]); ?></title>
        <?php $addCss=""; $addJs=""; $currentNav ='企业账户列表'; ?>
            ...
            <?php if(is_array($sub_menu)): foreach($sub_menu as $key=>$sv): ?><li><a href="<?php echo ($sv["url"]); ?>"><?php echo ($sv["title"]); ?></a></li><?php endforeach; endif; ?>
                ...
                <div id="Right">
                    <div class="Item hr">
                        ...
                        <div style="width: 100px;float: right;"><button type="button" class="btn" onclick="window.location.href='<?php echo U('Product/enterprise_add');?>'">添加企业账户</button></div>
                    </div>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr align="center" id="<?php echo ($vo["id"]); ?>">
                                ...
                                <td>[ <a href="/index.php/conist/Product/enterprise_add?id=<?php echo ($vo["id"]); ?>">编辑 </a> ] [ <a link="<?php echo U('Product/enterprise_del/',array('id'=>$vo['id']));?>" href="javascript:void(0)" name="<?php echo ($vo["pay_code"]); ?>" class="del">删除 </a> ]</td>
