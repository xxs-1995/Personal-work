        ...
        <div id="Right">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tab">
                ...
                <tr><td colspan="7" align="left">
                            <form action="/index.php/conist/Personal/index" method="get">
                ...
                <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tree): $mod = ($i % 2 );++$i;?><tr pid="<?php echo ($tree["id"]); ?>" cid="<?php echo ($tree["id"]); ?>">
                        ...
                        <td  align="center"><?php echo ($tree["account"]); ?></td>
                        <!-- 2 -->
                      ...
                      <!--   <td align="center"></td> -->
                        ...
                        <td align="center" ><!-- <button class="btn" onclick="window.location.href='<?php echo U('Personal/picarr');?>?id=<?php echo ($tree["user_id"]); ?>'">相册</button> -->
                            ...
                            <button class="btn" onclick="window.location.href='<?php echo U('Personal/top_up');?>?user_id=<?php echo ($tree["user_id"]); ?>'">充值记录</button>
                            <button class="btn" onclick="window.location.href='<?php echo U('Personal/withdrawals');?>?user_id=<?php echo ($tree["user_id"]); ?>'">提现记录</button>
                            <button class="btn" onclick="window.location.href='<?php echo U('Personal/computing');?>?user_id=<?php echo ($tree["user_id"]); ?>'">佣金记录</button>
                        </td>
