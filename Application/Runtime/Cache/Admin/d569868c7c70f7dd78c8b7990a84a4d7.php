...
<head>
    ...
    <?php $addCss=""; $addJs=""; $currentNav ='编辑企业账户'; ?>
    ...
    <div class="subMenuList">
        ...
        <div id="Right">
            <div class="contentArea">
                <div class="Item hr">
                    <div class="current">编辑企业账户</div>
                </div>
                <form method="post" enctype="multipart/form-data">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                        <tr>
                            <th width="120">企业账户收款码：</th>
                            <td>
                                <input type="text" name="pay_code" class="input uname" size="40" value="<?php echo ($list["pay_code"]); ?>"/>
                            </td>
                        </tr>
                        <tr>
                            <th width="120">企业账户二维码：</th>
                            <td>
                        ...
                        <tr>
                            <th width="120"></th>
                            <td>
                                <?php if($list['qr_code'] != ''): ?><div style="width:300px;height:200px;">
                                    <img src="<?php echo ($list["qr_code"]); ?>" style="width:200px;height:200px;">
                                </div><?php endif; ?>
                            </td>
                        </tr>
                    </table>
