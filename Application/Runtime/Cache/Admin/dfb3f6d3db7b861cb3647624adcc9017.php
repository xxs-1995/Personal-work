                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                        ...
                        <tr>
                            ...
                            <td><select name="info[position]" style="width: 140px;">
                                ...
                                <option value="banner" <?php if($info['position'] == 'banner'): ?>selected<?php endif; ?>>banner</option>
                                <option value="blockworld" <?php if($info['position'] == 'blockworld'): ?>selected<?php endif; ?>>blockworld大图</option>
                                <option value="invite" <?php if($info['position'] == 'invite'): ?>selected<?php endif; ?>>邀请页大图</option>

                                <option value="invite2" <?php if($info['position'] == 'invite2'): ?>selected<?php endif; ?>>邀请页二维码</option>
                                <option value="shop" <?php if($info['position'] == 'shop'): ?>selected<?php endif; ?>>商城页大图</option>
                        ...
                        <tr>
                            <th>图片显示：</th>
                            <td><a href="<?php echo ($info["ad_img"]); ?>" target="_blank"><img src="<?php echo ($info["ad_img"]); ?>" border="0" height="40" width="200"></a></td>
                        </tr>
                        <?php } ?>
                        <tr>
                            <th>产品内容：</th>
...
$("#checkNewsTitle").click(function(){
    ...
    $.getJSON("/index.php/conist/Siteinfo/checkProductTitle", { title:$("#title").val(),id:"<?php echo ($info["id"]); ?>"}, function(json){
