...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <?php $addCss=""; $addJs=""; $currentNav ='参数设置 > 代理设置'; ?>
    ...
    <div class="subMenuList">
        ...
        <ul>
            <?php if(is_array($sub_menu)): foreach($sub_menu as $key=>$sv): ?><li><a href="<?php echo ($sv["url"]); ?>"><?php echo ($sv["title"]); ?></a></li><?php endforeach; endif; ?>
                ...
                <div id="Right">
                    <div class="Item hr">
                        <div class="current">代理列表(<?php echo ($count); ?>)</div>
                        <span style="float:right"><div class="current"><a href="/index.php/conist/Product/agentadd">添加代理</a></div></span>
                    </div>
                    <div class="Item hr">
                        <div class=""><a href="/index.php/conist/Product/agent/type/1">区县代理</a></div>
                        <div class=""><a href="/index.php/conist/Product/agent/type/2">市级代理</a></div>
                        <div class=""><a href="/index.php/conist/Product/agent/type/3">省级代理</a></div>
                    </div>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr align="center" id="<?php echo ($vo["id"]); ?>">
                                ...
                                <td>[ <a href="/index.php/conist/Product/edit?id=<?php echo ($vo["id"]); ?>">编辑 </a> ] [ <a link="<?php echo U('Product/delagent/',array('id'=>$vo['did']));?>" href="javascript:void(0)" name="<?php echo ($vo["user_nickname"]); ?>" class="del">删除 </a> ]</td>
