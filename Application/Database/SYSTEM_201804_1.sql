...
CREATE TABLE `pa_category` (
  ...
  `lang` varchar(10) NOT NULL DEFAULT 'zh-cn',
  PRIMARY KEY (`cid`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='新闻分类表' ;
...
CREATE TABLE `pa_computing` (
  ...
  `createtime` int(11) NOT NULL,
  `type` char(20) NOT NULL COMMENT '算力获得的途径   give赠送 buy租用 sign签到 trans转账',
  PRIMARY KEY (`id`)
...
CREATE TABLE `pa_mining` (
  ...
  `user_id` int(11) NOT NULL,
  `createtime` int(11) NOT NULL,
  `insur` decimal(30,10) NOT NULL COMMENT '挖矿数量',
  `receive` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否领取',
  `num` int(11) DEFAULT NULL COMMENT '挖矿编号',
  `receive_time` int(11) DEFAULT NULL COMMENT '领取时间  挖矿时间',
  PRIMARY KEY (`id`)
...
CREATE TABLE `pa_personal` (
  ...
  `user_nickname` char(100) NOT NULL DEFAULT '' COMMENT '会员昵称',
  ...
  `recsuanli` int(11) DEFAULT '0' COMMENT '推荐人获得的算力',
  PRIMARY KEY (`user_id`)
...
INSERT INTO `pa_category` VALUES ('1','0','关于我们','n','zh-cn');
INSERT INTO `pa_category` VALUES ('2','0','客服咨询','n','zh-cn');
...
INSERT INTO `pa_computing` VALUES ('1','24','100','0','1533214567','');
INSERT INTO `pa_computing` VALUES ('2','1','120','0','0','');
INSERT INTO `pa_computing` VALUES ('3','3','50','0','0','');
INSERT INTO `pa_computing` VALUES ('4','24','45','0','0','');
INSERT INTO `pa_computing` VALUES ('8','24','100','1524315722','1521723722','buy');
INSERT INTO `pa_computing` VALUES ('9','24','100','1524315731','1521723731','buy');
INSERT INTO `pa_computing` VALUES ('10','24','100','1524315756','1521723756','buy');
INSERT INTO `pa_computing` VALUES ('11','25','20','1524315756','1521723756','give');
INSERT INTO `pa_computing` VALUES ('12','24','2','0','1521789891','sign');
INSERT INTO `pa_computing` VALUES ('13','24','300','1524382195','1521790195','buy');
INSERT INTO `pa_computing` VALUES ('14','25','60','1524382195','1521790195','give');
INSERT INTO `pa_computing` VALUES ('15','24','2','0','1522310611','sign');
...
INSERT INTO `pa_liveset` VALUES ('1','','10','0.20','1','0.2134000000','1','0.0010');
...
# 数据库表：pa_mining 数据信息
INSERT INTO `pa_mining` VALUES ('1','24','0','0.1214820000','0','1','1532152314');
INSERT INTO `pa_mining` VALUES ('2','24','0','0.1542120000','0','2','1532152456');
INSERT INTO `pa_mining` VALUES ('4','1','1521789150','21.3400000000','0','3','');
INSERT INTO `pa_mining` VALUES ('5','2','1521789150','21.3400000000','0','3','');
INSERT INTO `pa_mining` VALUES ('6','24','1521789150','85.3600000000','0','3','');
INSERT INTO `pa_mining` VALUES ('7','25','1521789150','25.6080000000','0','3','');
INSERT INTO `pa_mining` VALUES ('8','47','1521789150','21.3400000000','0','3','');
INSERT INTO `pa_mining` VALUES ('9','48','1521789150','21.3400000000','0','3','');
INSERT INTO `pa_mining` VALUES ('10','1','1521789173','21.3400000000','0','4','');
INSERT INTO `pa_mining` VALUES ('11','2','1521789173','21.3400000000','0','4','');
INSERT INTO `pa_mining` VALUES ('12','24','1521789173','85.3600000000','0','4','');
INSERT INTO `pa_mining` VALUES ('13','25','1521789173','25.6080000000','0','4','');
INSERT INTO `pa_mining` VALUES ('14','47','1521789173','21.3400000000','0','4','');
INSERT INTO `pa_mining` VALUES ('15','48','1521789173','21.3400000000','0','4','');
INSERT INTO `pa_mining` VALUES ('16','1','1521810187','21.3400000000','0','5','');
INSERT INTO `pa_mining` VALUES ('17','2','1521810187','21.3400000000','0','5','');
INSERT INTO `pa_mining` VALUES ('18','24','1521810187','149.3800000000','0','5','');
INSERT INTO `pa_mining` VALUES ('19','25','1521810187','38.4120000000','0','5','');
INSERT INTO `pa_mining` VALUES ('20','47','1521810187','21.3400000000','0','5','');
INSERT INTO `pa_mining` VALUES ('21','48','1521810187','21.3400000000','0','5','');
...
# 数据库表：pa_news 数据信息
INSERT INTO `pa_news` VALUES ('1','1','关于我们','','','','采矿业指对固体（如煤和矿物）、液体（如原油）或气体（如天然气）等自然产生的矿物的采掘。包括地下或地上采掘、矿井的运行，以及一般在矿址或矿址附近从事的旨在加工原材料的所有辅助性工作，例如破磨、选矿和处理，均属本类活动。还包括使原料得以销售所需的准备工作。但不包括水的蓄集、净化和分配，以及地质勘查、建筑工程活动。','1521769269','','<span style="color:#333333;font-family:arial, 宋体, sans-serif;font-size:14px;background-color:#FFFFFF;">采矿业指对固体（如煤和矿物）、液体（如</span><a target="_blank" href="https://baike.baidu.com/item/%E5%8E%9F%E6%B2%B9">原油</a><span style="color:#333333;font-family:arial, 宋体, sans-serif;font-size:14px;background-color:#FFFFFF;">）或气体（如天然气）等自然产生的矿物的采掘。包括地下或地上采掘、矿井的运行，以及一般在矿址或矿址附近从事的旨在加工原材料的所有辅助性工作，例如破磨、选矿和处理，均属本类活动。还包括使原料得以销售所需的准备工作。但不包括水的蓄集、净化和分配，以及</span><a target="_blank" href="https://baike.baidu.com/item/%E5%9C%B0%E8%B4%A8%E5%8B%98%E6%9F%A5">地质勘查</a><span style="color:#333333;font-family:arial, 宋体, sans-serif;font-size:14px;background-color:#FFFFFF;">、建筑工程活动。</span><br />','0','1','0','0','zh-cn');
INSERT INTO `pa_news` VALUES ('2','2','咨询客服','','','','二维码又称二维条码，常见的二维码为QR Code，QR全称Quick Response，是一个近几年来移动设备上超流行的一种编码方式，它比传统的Bar Code条形码能存更多的信息，也能表示更多的数据类型。&nbsp;二维条码/二维码（2-dimensional bar code）是用...','1521769325','1521792008','<div class="c-span18 c-span-last" style="color:#333333;font-family:arial;font-size:13px;background-color:#FFFFFF;">
	<p style="text-align:center;">
		<span style="color:#CC0000;">二维码</span>又称<span style="color:#CC0000;">二维</span>条码，常见的<span style="color:#CC0000;">二维码</span>为QR Code，QR全称Quick Response，是一个近几年来移动设备上超流行的一种编码方式，它比传统的Bar Code条形码能存更多的信息，也能表示更多的数据类型。&nbsp;<span style="color:#CC0000;">二维</span>条码/<span style="color:#CC0000;">二维码</span>（2-dimensional bar code）是用...<img class="c-img c-img6" src="https://ss0.baidu.com/6ONWsjip0QIZ8tyhnq/it/u=1062989499,1682648318&fm=58" style="width:121px;" /> 
	</p>
</div>','0','1','0','0','zh-cn');
...
# 数据库表：pa_order 数据信息
INSERT INTO `pa_order` VALUES ('1','-2','24','1521774166');
INSERT INTO `pa_order` VALUES ('2','+2','47','1521774166');
INSERT INTO `pa_order` VALUES ('3','-2','24','1521790724');
INSERT INTO `pa_order` VALUES ('4','+2','47','1521790724');
...
INSERT INTO `pa_personal` VALUES ('24','0','0','哈撒ki1','99','0','/Uploads/Iecture/2018-03-14/5aa8cdb17c7ff.jpg','/Public/Img/default/bgdefault.jpg','15134041905','17384.0000000000','103b70723e4dc645882f46323c2f6d44','sada','asdasdaaaz','老板','1','0','0','','1521027843','1511317819','132456@126.com','','','','f2a463b1bab23217398497b84e2aee15','高中','动画','','0','123456','HIHDFuqcAwFBOr6TRn2CqMCCjH4o6JjLdHR8Js6hTz8S7IBVEz','','0','1516320754','0','25','100','','');
...
INSERT INTO `pa_personal` VALUES ('47','0','0','','0','0','/Uploads/Iecture/2018-03-07/5a9f7c58d8662.png','/Public/Img/default/bgdefault.jpg','15231115232','-2.0000000000','e10adc3949ba59abbe56e057f20f883e','yhyy','','未填写','0','0','0','','1522214422','1519872474','','','','','7a187816348eb4774b2ce73fe07baa9e','高中','','','0','872474','','','0','','0','','100','','');
